...
console.log(combinaTexto+num1);//ABC 10
console.log(combinaTexto + num1 + num2);//ABC20
...
n++; //sumamos 1 a lo que antesteníamos
console.log(n);

n-= 4; //está restando a lo que teniamos en n
n--; //restando 1
console.log(n);
